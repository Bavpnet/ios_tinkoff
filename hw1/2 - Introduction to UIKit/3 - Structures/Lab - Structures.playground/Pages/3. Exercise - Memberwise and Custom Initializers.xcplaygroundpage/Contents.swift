...
let favoriteBook = Book(title: "Преступление и Наказание", author: "Достоевский", pages: 350, price: 100)
print("This book is \(favoriteBook.title) authored by \(favoriteBook.author) with \(favoriteBook.pages) pages and price \(favoriteBook.price)")
/*:
...
let laptop1 = Laptop(screenSize: 15, repairCount: 1, yearPurchased: 2021)
let laptop2 = Laptop(screenSize: 13, yearPurchased: 2023)


print(laptop1.screenSize, laptop1.repairCount, laptop1.yearPurchased)
print(laptop2.screenSize, laptop2.yearPurchased)
...
struct Height{
    ...
    var heightInCenimeters: Double
       ...
       init(inches: Double) {
           ...
           self.heightInCenimeters = inches * 2.54
       }

       init(centimeters: Double) {
           self.heightInCenimeters = centimeters
...
if someonesHeight.heightInCenimeters == 165.1 {
    print("That is true")
} else {
...
print("Inches \(myHeight.heightInInches)")

myHeight = Height(inches: 69.3)
print("Inches \(myHeight.heightInCenimeters)")
