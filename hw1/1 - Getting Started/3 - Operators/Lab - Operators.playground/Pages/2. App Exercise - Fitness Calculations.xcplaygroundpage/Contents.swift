...
// We get a different results due to different types (Int and Double).
// I converted contansts by method Double() that is mention in task condition.
...
print("You achieved \(percentOfGoal)% of goal");
